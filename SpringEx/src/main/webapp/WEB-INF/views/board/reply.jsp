	...
	<!-- 로고 / GNB가 나오는 부분 -->
		...
		<div class="body">
			...
			<div class="cont1">
				<br />
				<fieldset>
					<legend>자료실 답글쓰기</legend>
					<form name="writeFrm" action="<c:url value="/board/replyAction.do" />" 
					...
					<table width="770" border="1" cellspacing="0" cellpadding="2">
						...
						<tr>
							<td>내용</td>
							<td>
								<textarea name="content" style="width:90%; height:200px">${replyRow.content}</textarea>
							</td>
						</tr>
						<tr>
							<td width="20%">패스워드</td>
