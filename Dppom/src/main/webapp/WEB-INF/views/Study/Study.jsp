...
<%@ include file="/WEB-INF/layout/head.jsp" %>
        ...
        <link rel="stylesheet" href="./resources/study/bootstrap/css/bootstrap.min.css">
        <link rel="stylesheet" href="./resources/study/font-awesome/css/font-awesome.min.css">
        <link rel="stylesheet" href="./resources/study/css/animate.css">
        <link rel="stylesheet" href="./resources/study/css/magnific-popup.css">
        <link rel="stylesheet" href="./resources/study/flexslider/flexslider.css">
        <link rel="stylesheet" href="./resources/study/css/form-elements.css">
        <link rel="stylesheet" href="./resources/study/css/style.css">
        <link rel="stylesheet" href="./resources/study/css/media-queries.css">
   ...
   <div class="wrap_cont_necessary" >
      ...
      <div class="row">
         <div class="col-md-8 col-md-offset-2 to-animate">
            <h2 style="font-family:Source Sans Pro, Arial, sans-serif;">STUDY</h2>
         </div>
      </div>
   </div> 
</div>
...
<!-- Portfolio -->
        ...
        <script src="./resources/study/js/jquery-1.11.1.min.js"></script>
        <script src="./resources/study/bootstrap/js/bootstrap.min.js"></script>
        <script src="./resources/study/js/bootstrap-hover-dropdown.min.js"></script>
        <script src="./resources/study/js/jquery.backstretch.min.js"></script>
        <script src="./resources/study/js/wow.min.js"></script>
        <script src="./resources/study/js/retina-1.1.0.min.js"></script>
        <script src="./resources/study/js/jquery.magnific-popup.min.js"></script>
        <script src="./resources/study/flexslider/jquery.flexslider-min.js"></script>
        <script src="./resources/study/js/jflickrfeed.min.js"></script>
        <script src="./resources/study/js/masonry.pkgd.min.js"></script>
        <script src="http://maps.google.com/maps/api/js?sensor=true"></script>
        <script src="./resources/study/js/jquery.ui.map.min.js"></script>
        <script src="./resources/study/js/scripts.js"></script>
