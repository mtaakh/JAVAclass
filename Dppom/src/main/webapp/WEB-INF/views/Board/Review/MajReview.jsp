	...
	<div class="container">
		<div class="row" id="team">
			...
			<div class="row row-bottom-padded-lg" id="about-us" >
				...
				<div class="row" >
				<div class="col-md-6">
					<h3> <a id="cate" href="Review" style="text-decoration:none; color:#6c727a;" ><b>전 공 Review</b></a> </h3>
				</div>
				<div class="col-md-6">
					<h3><a id="cate" href="LibReview" style="text-decoration:none; color:#6c727a;">교 양 Review</a> </h3>
				</div>
				</div>
				</div>
