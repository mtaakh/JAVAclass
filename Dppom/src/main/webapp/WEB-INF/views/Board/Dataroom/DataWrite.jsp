					...
					<div class="row" >
						...
						<thead>
							 <tr >
								...
								<span style="color:green">데이터</span> 게시판 글쓰기</th>
							</tr> 
						...
						<tbody>
							<tr>
								...
								<th  style="width:10%;">
									<select id="cate" id="sel1" name="category" style="width:80%; height:40px;margin-left:40px">
										<option value="">선택</option>
										<option value="">족보</option>
										<option value="">ppt</option>
										<option value="">레포트</option>
									</select>
								</th>
								<th colspan="2">
